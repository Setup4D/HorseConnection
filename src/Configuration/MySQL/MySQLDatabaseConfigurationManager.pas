...
{   com o banco de dados MySQL usando FireDAC. Permite criar definições }
{   de conexão reutilizáveis e personalizadas.                          }
{                                                                       }
...
{$ELSE}
  ...
  {                          HorseConnection                              }
  {                                                                       }
  { Unidad: MySQLDatabaseConfigurationManager                             }
  {                                                                       }
  { Descripción:                                                          }
  {   Esta unidad proporciona funciones para gestionar configuraciones    }
  {   de conexión con la base de datos MySQL usando FireDAC. Permite      }
  ...
  {                                                                       }
  { Description:                                                          }
  {   This unit provides functions for managing MySQL database connection }
  {   configurations using FireDAC. It allows creating reusable and       }
  {   custom connection definitions.                                      }
  {                                                                       }
...
{$IFDEF PORTUGUES}
/// <summary>
///   Inicializa a configuração do FireDAC para o banco de dados MySQL com base nas
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Inicializa la configuración de FireDAC para la base de datos MySQL según
  ...
  {$ELSE}
  /// <summary>
  ///   Initializes the FireDAC configuration for the MySQL database based on the
...
{$IFDEF PORTUGUES}
/// <summary>
///   Inicializa a configuração do FireDAC para o banco de dados MySQL com base apenas
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Inicializa la configuración de FireDAC para la base de datos MySQL según solo
  ...
  {$ELSE}
  /// <summary>
  ///   Initializes the FireDAC configuration for the MySQL database based only on
...
{$IFDEF PORTUGUES}
/// <summary>
///   Cria uma lista de parâmetros de conexão para o banco de dados MySQL com base nas configurações fornecidas.
/// </summary>
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Crea una lista de parámetros de conexión para la base de datos MySQL según las configuraciones proporcionadas.
  /// </summary>
  ...
  {$ELSE}
  /// <summary>
  ///   Creates a list of connection parameters for the MySQL database based on the provided settings.
  /// </summary>
