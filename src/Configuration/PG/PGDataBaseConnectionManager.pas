...
{   dados PostgreSQL usando FireDAC. Permite a criação de conexões      }
...
{$ELSE}
  ...
  {                          HorseConnection                              }
  {                                                                       }
  { Unidad: PGDatabaseConnectionManager                                   }
  {                                                                       }
  { Descripción:                                                          }
  {   Esta unidad proporciona funciones para gestionar conexiones con     }
  {   la base de datos PostgreSQL usando FireDAC. Permite la creación     }
  {   de conexiones reutilizables y personalizadas, además de gestionar   }
  ...
  {   PostgreSQL database using FireDAC. It allows the creation of        }
...
{$IFDEF PORTUGUES}
/// <summary>
///   Retorna uma conexão com o banco de dados PostgreSQL com base nas configurações
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Devuelve una conexión a la base de datos PostgreSQL según las configuraciones
  ///   proporcionadas, el nombre de la base de datos y el prefijo.
  /// </summary>
  /// <param name="AConfiguration">
  ///   La configuración de la base de datos PostgreSQL.
  /// </param>
  /// <param name="ADatabase">
  ...
  {$ELSE}
  /// <summary>
  ///   Returns a connection to the PostgreSQL database based on the provided
...
{$IFDEF PORTUGUES}
/// <summary>
///   Retorna uma conexão com o banco de dados PostgreSQL com base apenas nas configurações
///   fornecidas.
/// </summary>
/// <param name="AConfiguration">
///   A configuração do banco de dados PostgreSQL.
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Devuelve una conexión a la base de datos PostgreSQL según solo las configuraciones
  ///   proporcionadas.
  /// </summary>
  /// <param name="AConfiguration">
  ///   La configuración de la base de datos PostgreSQL.
  ...
  {$ELSE}
  /// <summary>
  ///   Returns a connection to the PostgreSQL database based only on the provided
  ///   configuration.
  /// </summary>
  /// <param name="AConfiguration">
  ///   The PostgreSQL database configuration.
  ...
  {$ENDIF}
{$ENDIF}
function GetConnection(const AConfiguration: TPGConfiguration): TFDConnection; overload;
...
var
  ...
  {$IFDEF PORTUGUES}
/// <summary>
///   Configura uma conexão com o banco de dados PostgreSQL com base nas configurações e parâmetros fornecidos.
/// </summary>
/// <param name="AConfiguration">A configuração do banco de dados PostgreSQL.</param>
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Configura una conexión con la base de datos PostgreSQL según las configuraciones y parámetros proporcionados.
  /// </summary>
  /// <param name="AConfiguration">La configuración de la base de datos PostgreSQL.</param>
  ...
  {$ELSE}
  /// <summary>
  ///   Sets up a connection to the PostgreSQL database based on the provided configurations and parameters.
  /// </summary>
  /// <param name="AConfiguration">The PostgreSQL database configuration.</param>
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Devuelve una conexión predeterminada a la base de datos PostgreSQL.
  ...
  {$ELSE}
  /// <summary>
  ///   Returns a default connection to the PostgreSQL database.
...
{$IFDEF PORTUGUES}
/// <summary>
///   Retorna uma conexão personalizada com o banco de dados PostgreSQL.
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Devuelve una conexión personalizada a la base de datos PostgreSQL.
  ...
  {$ELSE}
  /// <summary>
  ///   Returns a custom connection to the PostgreSQL database.
