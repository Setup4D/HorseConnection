...
{   com o banco de dados PostgreSQL usando FireDAC. Permite criar       }
...
{$ELSE}
  ...
  {                          HorseConnection                              }
  {                                                                       }
  { Unidad: PGDatabaseConfigurationManager                                }
  {                                                                       }
  { Descripción:                                                          }
  {   Esta unidad proporciona funciones para gestionar configuraciones    }
  {   de conexión con la base de datos PostgreSQL usando FireDAC. Permite }
  ...
  {                                                                       }
  { Description:                                                          }
  {   This unit provides functions for managing PostgreSQL database       }
...
{$IFDEF PORTUGUES}
/// <summary>
///   Inicializa a configuração do FireDAC para o banco de dados PostgreSQL com base nas
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Inicializa la configuración de FireDAC para la base de datos PostgreSQL según
  ...
  {$ELSE}
  /// <summary>
  ///   Initializes the FireDAC configuration for the PostgreSQL database based on the
...
{$IFDEF PORTUGUES}
/// <summary>
///   Inicializa a configuração do FireDAC para o banco de dados PostgreSQL com base apenas
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Inicializa la configuración de FireDAC para la base de datos PostgreSQL según solo
  ...
  {$ELSE}
  /// <summary>
  ///   Initializes the FireDAC configuration for the PostgreSQL database based only on
...
{$IFDEF PORTUGUES}
/// <summary>
///   Cria uma lista de parâmetros de conexão para o banco de dados PostgreSQL com base nas configurações fornecidas.
/// </summary>
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Crea una lista de parámetros de conexión para la base de datos PostgreSQL según las configuraciones proporcionadas.
  /// </summary>
  ...
  {$ELSE}
  /// <summary>
  ///   Creates a list of connection parameters for the PostgreSQL database based on the provided settings.
  /// </summary>
