...
{$ELSE}
  ...
  {   de conexión con la base de datos SQLite usando FireDAC. Permite     }
...
{$IFDEF PORTUGUES}
/// <summary>
///   Inicializa a configuração do FireDAC para o banco de dados SQLite com base nas
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Inicializa la configuración de FireDAC para la base de datos SQLite según
...
{$IFDEF PORTUGUES}
/// <summary>
///   Inicializa a configuração do FireDAC para o banco de dados SQLite com base apenas
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Inicializa la configuración de FireDAC para la base de datos SQLite según solo
...
{$IFDEF PORTUGUES}
/// <summary>
///   Cria uma lista de parâmetros de conexão para o banco de dados SQLite com base nas configurações fornecidas.
/// </summary>
...
{$ELSE}
  {$IFDEF ESPANHOL}
  /// <summary>
  ///   Crea una lista de parámetros de conexión para la base de datos SQLite según las configuraciones proporcionadas.
  /// </summary>
