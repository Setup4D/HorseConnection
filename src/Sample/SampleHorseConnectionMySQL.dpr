...
{  ApplyDatabaseConfiguration(TPGConfigurationParameter.Server, 'custom_localhost');
  ...
  ApplyDatabaseConfiguration(TPGConfigurationParameter.VendorLib, 'custom_VendorLib');
  ...
  THorse.Get('/produtos',
    ...
    begin
      ...
      try
        ...
        FDQuery.Connection := GetConnection(TConnectionType.MySQL);  // Obtém a conexão única do middleware
